...
switch (selectedOption) {
    case 0: // Buy Tin
        selectedItemInfo = "Tin Price: " + string(T_tinPrice * Tax) + " | Weight: " + string(tinWeight) + " | Trader Qty: " + string(tinQuantity) + " | Player Qty: " + string(obj_Boat.playerTin);
        break;
    case 1: // Buy Copper
        selectedItemInfo = "Copper Price: " + string(T_copperPrice * Tax) + " | Weight: " + string(copperWeight) + " | Trader Qty: " + string(copperQuantity) + " | Player Qty: " + string(obj_Boat.playerCopper);
        break;
    case 2: // Buy Wheat
        selectedItemInfo = "Wheat Price: " + string(T_wheatPrice * Tax) + " | Weight: " + string(wheatWeight) + " | Trader Qty: " + string(wheatQuantity) + " | Player Qty: " + string(obj_Boat.playerWheat);
        break;
    case 3: // Buy Provisions
        selectedItemInfo = "Provisions Price: " + string(T_provisionPrice * Tax) + " | Weight: " + string(provisionWeight) +  " | Player Qty: " + string(obj_Boat.daysOfProvisions);
        break;
    case 4: // Sell Tin
        selectedItemInfo = "Tin Price: " + string(T_tinPrice) + " | Weight: " + string(tinWeight) + " | Trader Qty: " + string(tinQuantity) + " | Player Qty: " + string(obj_Boat.playerTin);
        break;
    case 5: // Sell Copper
        selectedItemInfo = "Copper Price: " + string(T_copperPrice) + " | Weight: " + string(copperWeight) + " | Trader Qty: " + string(copperQuantity) + " | Player Qty: " + string(obj_Boat.playerCopper);
        break;
    case 6: // Sell Wheat
        selectedItemInfo = "Wheat Price: " + string(T_wheatPrice) + " | Weight: " + string(wheatWeight) + " | Trader Qty: " + string(wheatQuantity) + " | Player Qty: " + string(obj_Boat.playerWheat);
        break;
}
