  ...
  if (point_in_rectangle(mouse_x, mouse_y, sprite_x1, sprite_y1, sprite_x2, sprite_y2) )
{
    ...
    draw_text(text_x, text_y, obj_CrewCon.NavFirstName);
    draw_text(text_x, text_y + 50, obj_CrewCon.NavFamilyName);
    draw_text(text_x, text_y + 100, "Health: " + string(obj_CrewCon.NavHealth));
	 draw_text(text_x, text_y + 150, "Job: Navigator");
