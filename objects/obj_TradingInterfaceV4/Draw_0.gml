...
switch (selectedOption) {
    case 0: // Buy Tin
        selectedItemInfo = "Tin Price: " + string(vil1_tinPrice * Tax) + " | Weight: " + string(tinWeight) + " | Trader Qty: " + string(tinQuantity) + " | Player Qty: " + string(obj_Boat.playerTin);
        break;
    case 1: // Buy Copper
        selectedItemInfo = "Copper Price: " + string(vil1_copperPrice * Tax) + " | Weight: " + string(copperWeight) + " | Trader Qty: " + string(copperQuantity) + " | Player Qty: " + string(obj_Boat.playerCopper);
        break;
    case 2: // Buy Wheat
        selectedItemInfo = "Wheat Price: " + string(vil1_wheatPrice * Tax) + " | Weight: " + string(wheatWeight) + " | Trader Qty: " + string(wheatQuantity) + " | Player Qty: " + string(obj_Boat.playerWheat);
        break;
    case 3: // Buy Provisions
        selectedItemInfo = "Provisions Price: " + " | Weight: " + string(provisionWeight) + " | Trader Qty: " + string(provisionsQuantiy) + " | Player Qty: " + string(obj_Boat.daysOfProvisions);
        break;
    case 4: // Sell Tin
        selectedItemInfo = "Tin Price: " + string(vil1_tinPrice) + " | Weight: " + string(tinWeight) + " | Trader Qty: " + string(tinQuantity) + " | Player Qty: " + string(obj_Boat.playerTin);
        break;
    case 5: // Sell Copper
        selectedItemInfo = "Copper Price: " + string(vil1_copperPrice) + " | Weight: " + string(copperWeight) + " | Trader Qty: " + string(copperQuantity) + " | Player Qty: " + string(obj_Boat.playerCopper);
        break;
    case 6: // Sell Wheat
        selectedItemInfo = "Wheat Price: " + string(vil1_wheatPrice) + " | Weight: " + string(wheatWeight) + " | Trader Qty: " + string(wheatQuantity) + " | Player Qty: " + string(obj_Boat.playerWheat);
        break;
}
