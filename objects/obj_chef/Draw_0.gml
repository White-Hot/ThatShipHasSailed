  ...
  if (point_in_rectangle(mouse_x, mouse_y, sprite_x1, sprite_y1, sprite_x2, sprite_y2))
{
    ...
    draw_text(text_x, text_y, obj_CrewCon.CookFirstName);
    draw_text(text_x, text_y + 50, obj_CrewCon.CookFamilyName);
    draw_text(text_x, text_y + 100, "Health: " + string(obj_CrewCon.CookHealth));
	 draw_text(text_x, text_y + 150, "Job: Cook");
